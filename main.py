...
from code.general_use_func import get_file_list, check_format, get_config, save_config, check_file_values, check_col_header
from code.readers import reader as rd
from code.xavier import safe_df as sf
from code.duplicates import duplicates_df, check_duplicates, check_xlsx
...
def get_entry(bnt):
    ...
    def get_header(bnt):
        ...
        def get_options(bnt):
            ...
            sf(df_safe, dir)  # saves data frame as output.xlsx
        ...
        if check2:  # check file name
            ...
            if check3:  # check column headers
                df = rd(dir, file_list, form, file_h)  # reader function extracts all data in pandas data frame
